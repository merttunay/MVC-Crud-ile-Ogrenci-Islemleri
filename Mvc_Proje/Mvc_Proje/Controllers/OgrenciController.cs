...
namespace Mvc_Proje.Controllers
{
    public class OgrenciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OgrID,OgrAd,OgrSoyad,OgrMail,OgrAdres")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OgrID,OgrAd,OgrSoyad,OgrMail,OgrAdres")] Table table)
        {
            if (ModelState.IsValid)
            {
